...
a idempotência mantém o recurso no mesmo estado se ele nao tiver sido alterado. O docker faz um double-check para verificar se aquele recurso já foi provisionado, se sim, o docker não faz nada, senão ele criar aquele recurso. Isso ajuda a evitar duplicidades.
